...
function tables_and_charts ($type, $output) {
    ...
    $out = pagination($count_non_null_rows, $offset_switch, plugin_page( 'people_by_handlers' ));
    ...
    <div id="databox">
        ...
        <table class="space10Before" stype="border-spacing: 0; border-collapse: collapse;">
            <tr>
                ...
                <td style="padding-left: 7px;"><?php echo lang_get( 'plugin_MantisStats_info_handler_current' ); ?></td>
            </tr>
        </table>
