...
// issues counts grouped by reporter and state
...
function tables_and_charts ( $type, $output ) {
    ...
    $out = pagination( $count_non_null_rows, $offset_switch, plugin_page( 'people_by_reporters' ) );
    ...
    <table class='width100' cellspacing='1'>
        <tr>
            <td width='100%' class='form-title'>" . lang_get( 'plugin_MantisStats_reporter_name' ) . "</td>";
...
<div id="wrapper">
    ...
    <div id="databox">
        ...
        <div id="titleText">
            <div id="title"><?php echo lang_get( 'plugin_MantisStats_reporters' ); ?></div>
...
<?php if ( $render_print_js != "no_render" ) { ?>
        ...
        <div id="reporters_open_chart"><?php echo lang_get( 'plugin_MantisStats_open_issues' ); ?></div>
	    ...
	    myChart.render("reporters_open_chart");
	    // ]]>
	    </script>
	    ...
	    <div id="reporters_resolved_chart"><?php echo lang_get( 'plugin_MantisStats_resolved_issues' ); ?></div>
	    <script type="text/javascript">
	    // <![CDATA[
        <?php echo $render_print_js; ?>
	    ...
	    myChart.render("reporters_resolved_chart");
	    // ]]>
	    </script>
