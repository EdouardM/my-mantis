...
function tables_and_charts ( $output ) {
	...
	$data_table_print = "
        <table class='width100' cellspacing='1'>
            <tr>
	            ...
	            <td class='heading'>" . lang_get( 'plugin_MantisStats_notes_open_issues' ) . "</td>
                <td class='heading'>" . lang_get( 'plugin_MantisStats_notes_res_issues' ) . "</td>
	            <td class='heading'>" . lang_get( 'plugin_MantisStats_notes_all_issues' ) . "</td>
            </tr>
    ";
    ...
    if( count( $data_table_totals ) > 0 ) {
        ...
        $out = pagination( count( $data_table_totals ), 1, plugin_page( 'people_by_notes' ) );
...
<div id="wrapper">
    ...
    <div id="databox">
        ...
        <strong><?php echo lang_get( 'plugin_MantisStats_top_note_adders' ); ?></strong>
        <p />
...
<?php if ( $render_print_js != "no_render" ) { ?>
        ...
        <p class="space30Before" />
        <strong><?php echo lang_get( 'plugin_MantisStats_top_note_add_chrt' ); ?></strong>

    	<div id="notes_added_by_chart"><?php echo lang_get( 'plugin_MantisStats_top_note_adders' ); ?></div>
	    ...
	    myChart.render("notes_added_by_chart");
	    // ]]>
	    </script>
